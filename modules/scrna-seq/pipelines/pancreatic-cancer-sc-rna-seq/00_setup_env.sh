...
# =============================================================================
# 00_setup_env.sh  (Peng 2019 PDAC — INDEPENDENT GPU reanalysis)
# BioIDE 헌장 제4조: 현대 GPU·Python 스택으로 재분석합니다. 이 파이프라인은
# 저자 라벨을 소비하지 않고(제1조) 새로 짠 코드로 세포유형·악성세포를 다시
# 도출하므로, Scanpy + PyTorch(GPU) + Harmony + scikit-learn 이 필요합니다.
...
echo "==> [00] GPU reanalysis environment for Peng 2019 PDAC: ${VENV}"
...
echo ""
echo "==> [00] Done. Next: 1. Download the Peng 2019 PDAC matrix (Zenodo .h5ad)."
