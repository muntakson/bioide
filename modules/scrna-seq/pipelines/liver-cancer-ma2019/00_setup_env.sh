...
# =============================================================================
# 00_setup_env.sh  (Ma 2019 liver cancer — INDEPENDENT GPU reanalysis)
# BioIDE 헌장 제4조: 현대 GPU·Python 스택으로 재분석합니다. 이 파이프라인은
# 저자 라벨을 소비하지 않고(제1조) 새로 짠 코드로 세포유형·악성 종양세포를
...
echo "==> [00] GPU reanalysis environment for Ma 2019 liver cancer: ${VENV}"
...
echo ""
echo "==> [00] Done. Next: 1. Download the Ma 2019 liver matrices (GEO GSE125449, Set1+Set2)."
