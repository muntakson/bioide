...
# =============================================================================
# 00_setup_env.sh  (Choi 2023 head&neck cancer — INDEPENDENT GPU reanalysis)
...
echo "==> [00] GPU reanalysis environment for Choi 2023 head&neck cancer: ${VENV}"
...
echo ""
echo "==> [00] Done. Next: 1. Download the Choi 2023 head&neck matrix (GEO GSE181919)."
