...
# =============================================================================
# 05_make_easy_report.sh  (NSCLC 폐암 종양 scRNA-seq)
...
RESULTS="${GHBIO_RESULTS:-${HOME}/ghbio-workspace/projects/scrna-seq-nsclc/results}"
...
cat "$SRC" > "$REPORT_MD"
if [[ -f "${RESULTS}/umap_clusters.png" ]]; then
  {
    printf '\n\n## 분석 지도 (UMAP)\n\n'
...
printf '\n\n<div class="foot">GHBIO Co-Scientist · NSCLC 폐암 종양 scRNA-seq · 작성일 %s · 이 문서는 교육용 고등학생 버전 보고서이며 임상적 증거가 아닙니다.</div>\n' "$REPORT_DATE" >> "$REPORT_MD"
