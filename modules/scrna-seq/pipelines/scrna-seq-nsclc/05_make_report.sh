...
#   --sample NAME   sample label on the cover (default: "10x Genomics Human NSCLC Tumor (GSE117570)")
...
SAMPLE="10x Genomics Human NSCLC Tumor (GSE117570)"
OUT=""
...
# Extra NSCLC figures (in order); each included only if 03 produced it. Numbers continue after Fig 2.
_extra = [
    ("nsclc_chart.png", "image/png",
     "NSCLC 종양 미세환경 세포 유형 구성 (draft) — Lambrechts et al., Nat Med 2018 카탈로그 대응",
     "각 클러스터를 대표 marker로 폐암 세포 유형에 배정한 뒤 유형별 <b>세포 수·비율</b>을 나타낸 막대그래프입니다. Lambrechts 2018의 <b>폐 종양 미세환경(TME) 세포 카탈로그</b>와 같은 관점입니다."),
    ("nsclc_stromal_distribution.webp", "image/webp",
     "간질(비종양) 세포 분포 — 생존 마커 (Lambrechts 2018·TCGA)",
     "종양을 뺀 <b>간질/미세환경 세포</b>의 분포입니다. 논문은 이 간질 세포 유형들이 <b>환자 생존과 연관</b>됨을 TCGA 1,572명 데이터로 보였는데, 그 <b>생존 분석 자체는 임상정보가 필요</b>해 단일 샘플인 이 예제에서는 분포만 보여줍니다."),
    ("nsclc_endothelial.webp", "image/webp",
     "내피세포(Endothelial) 클러스터 — Lambrechts 2018 (Fig. 2)",
     "왼쪽 UMAP은 내피세포 클러스터, 오른쪽은 내피 유전자의 클러스터별 z-score입니다. 종양 내피는 <b>혈관신생↑·면역세포 유인↓</b> 경향을 보입니다."),
    ("nsclc_fibroblast.webp", "image/webp",
     "섬유아세포(Fibroblast) 클러스터 — Lambrechts 2018 (Fig. 3)",
     "섬유아세포 클러스터와 <b>콜라겐 세트·근섬유아세포(ACTA2)·주변세포(RGS5)</b> 등 아형 marker 발현입니다. 논문은 섬유아세포가 서로 다른 콜라겐을 내는 여러 아형으로 나뉨을 보였습니다."),
    ("nsclc_bcell_myeloid.webp", "image/webp",
     "B세포·골수성세포 클러스터 — Lambrechts 2018 (Fig. 4)",
     "B/형질세포와 골수성세포(대식세포·수지상세포·비만세포) 클러스터입니다. 종양 대식세포는 <b>M2 성향</b>으로 치우치는 경향이 있습니다."),
    ("nsclc_tcell.webp", "image/webp",
     "T세포 클러스터 — Lambrechts 2018 (Fig. 5)",
     "T세포 아형(CD4/CD8·조절 T세포·세포독성)과 <b>면역관문 유전자(PDCD1·CTLA4·LAG3·TIGIT)</b> 발현입니다. 종양 T세포는 활성화와 함께 관문 분자가 오릅니다."),
]
_fign = 3
