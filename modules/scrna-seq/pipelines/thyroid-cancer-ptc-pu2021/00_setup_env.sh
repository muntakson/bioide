...
# =============================================================================
# 00_setup_env.sh  (Pu 2021 PTC — INDEPENDENT GPU reanalysis)
...
echo "==> [00] GPU reanalysis environment for Pu 2021 PTC: ${VENV}"
...
echo ""
echo "==> [00] Done. Next: 1. Download the Pu 2021 PTC matrices (GEO GSE184362_RAW.tar)."
