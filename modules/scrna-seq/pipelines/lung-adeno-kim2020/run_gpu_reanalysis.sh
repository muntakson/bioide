...
# =============================================================================
# run_gpu_reanalysis.sh  (Kim 2020 lung adeno — independent GPU reanalysis wrapper)
...
#
# 208k cells is a large run; pass extra args through, e.g. a faster subsampled
# run:  bash run_gpu_reanalysis.sh --max-cells 60000
# =============================================================================
...
echo "==> [02] Independent GPU reanalysis (Kim 2020 lung adeno) → ${RESULTS}"
