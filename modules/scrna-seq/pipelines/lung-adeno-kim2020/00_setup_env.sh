...
# =============================================================================
# 00_setup_env.sh  (Kim 2020 lung adenocarcinoma — INDEPENDENT GPU reanalysis)
...
echo "==> [00] GPU reanalysis environment for Kim 2020 lung adenocarcinoma: ${VENV}"
...
echo ""
echo "==> [00] Done. Next: 1. Download the Kim 2020 lung matrix (GEO GSE131907)."
