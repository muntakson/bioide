...
# =============================================================================
# 00_setup_env.sh  (Neftel 2019 GBM — INDEPENDENT GPU reanalysis)
# BioIDE 헌장 제4조: 현대 GPU·Python 스택으로 재분석합니다. 이 파이프라인은
# 저자 라벨을 소비하지 않고(제1조) 새로 짠 코드로 세포유형·악성 갑상선세포를
...
echo "==> [00] GPU reanalysis environment for Neftel 2019 GBM: ${VENV}"
...
echo ""
echo "==> [00] Done. Next: 1. Download the Neftel 2019 GBM matrices (GEO GSE184362_RAW.tar)."
