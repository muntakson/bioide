...
# =============================================================================
# 05_make_easy_report.sh  (Pan T세포 scRNA-seq)
...
RESULTS="${GHBIO_RESULTS:-${HOME}/ghbio-workspace/projects/scrna-seq-pan-t-cells/results}"
...
printf '\n\n<div class="foot">GHBIO Co-Scientist · Pan T세포 scRNA-seq · 작성일 %s · 이 문서는 교육용 고등학생 버전 보고서이며 임상적 증거가 아닙니다.</div>\n' "$REPORT_DATE" >> "$REPORT_MD"
