...
#   * v2 (this dataset): CB length 16, UMI length 10, whitelist 737K-august-2016.txt
# 이 데이터셋(4k Pan T cells)은 v2 chemistry입니다 (CB=16, UMI=10).
# =============================================================================

# ---- Configuration ----------------------------------------------------------
CHEMISTRY="v2"                                    # "v3" or "v2"

TUT="${HOME}/ghbio-tutorial"
STAR_BIN="${HOME}/bin/STAR"
INDEX_DIR="${TUT}/ref/star_index"
# The t_4k tar extracts to <DATA_DIR>/t_4k/fastqs/ (see 01_download_pan_t_cells.sh).
FASTQ_DIR="${TUT}/data/fastq/t_4k/fastqs"
